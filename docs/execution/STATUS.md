...
| Web internationalization     | IMPLEMENTED_SLICE | typed RU/EN shell, onboarding, discovery, billing, settings, chats, personas, characters, lorebooks, profiles and reports; E2E switch |
...
| Staging                      | VERIFIED          | Worker `4687cd16`; D1 25/63 healthy, paid gates off                                                                                   |
