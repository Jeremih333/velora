...
| Web internationalization     | IMPLEMENTED_SLICE | typed RU/EN shell, onboarding, discovery, billing, settings, chats, personas, characters and lorebooks; E2E switch |
...
| Staging                      | VERIFIED          | Worker `f89cd7e7`; D1 25/63 healthy, paid gates off                                                                |
