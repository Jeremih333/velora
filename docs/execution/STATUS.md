...
| Roleplay quality corpus      | VERIFIED_STRUCTURAL | A-F real prompt/lore assembly; paid model response remains gated                         |
...
| Staging                      | VERIFIED            | Worker `19904cde`; D1 25/63 healthy, BotHub READY, paid gates off                        |
