...
| Web internationalization     | IMPLEMENTED_SLICE | typed RU/EN product UX through profiles, reports, support, legal and data controls; admin operations remain |
...
| Staging                      | VERIFIED          | Worker `426f198c`; D1 25/63 healthy, BotHub READY, paid gates off                                           |
