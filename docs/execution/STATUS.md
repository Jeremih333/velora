...
| Web internationalization     | IMPLEMENTED_SLICE | typed RU/EN shell, onboarding, discovery, billing, settings and chats; E2E switch |
...
| Staging                      | VERIFIED          | Worker `2fef274a`; D1 25/63 healthy, paid gates off                               |
