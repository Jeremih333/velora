...
| Web internationalization     | IMPLEMENTED_SLICE | typed RU/EN shell, onboarding, discovery, billing, settings, chats, personas and character editor; E2E switch |
...
| Staging                      | VERIFIED          | Worker `0cf2cc06`; D1 25/63 healthy, paid gates off                                                           |
