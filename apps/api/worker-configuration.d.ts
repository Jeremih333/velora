/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config apps/api/wrangler.jsonc --env local --path apps/api/worker-configuration.d.ts` (hash: 587bb4e488ba49cd939dd49565f54ec8)
// Runtime types generated with workerd@1.20260305.0 2026-08-08
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    PER_USER_DAILY_AI_BUDGET_USD: '0.01';
